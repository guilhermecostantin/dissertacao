...
A \autopageref{fig_7} e a \autoref{fig_8} mostram a distribuição dos desenvolvedores pelo conjunto de classes original e pelo conjunto de 2 classes, respectivamente. É possível notar que, ao comparar a distribuição dos desenvolvedores pelo conjunto original de 5 classes (\autopageref{fig_7}) desse empresa com o conjunto das empresas em geral(\autopageref{fig_3}), a Empresa A também apresentou um baixo uso das duas classes de importância mais baixas, porém, por ter utilizado mais a classe de importância média, obteve uma distribuição dos desenvolvedores mais balanceada no que se diz respeito ao novo conjunto de duas classes.
