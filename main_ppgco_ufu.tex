...
% Referencial Teórico
% ----------------------------------------------------------
\include{cap_referencial/referencial}

% ----------------------------------------------------------
% Referencial Teórico
% ----------------------------------------------------------
\include{cap_metodologia/metodologia}

% ----------------------------------------------------------
% Referencial Teórico
% ----------------------------------------------------------
\include{cap_resultados_gerais/resultados_gerais}

% ----------------------------------------------------------
% Referencial Teórico
% ----------------------------------------------------------
\include{cap_resultados_individuais/resultados_individuais}

% ----------------------------------------------------------
% Discussão
% ----------------------------------------------------------
\include{cap_discussao/discussao}
